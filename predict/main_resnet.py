...
utils.create_folder(opt.models_resnet18dir)
...
for fold in [2]:
    ...
    tr_loss, val_loss, f1_overall_1sec_list, er_overall_1sec_list = [0] * opt.nb_epoch, [0] * opt.nb_epoch, [0] * opt.nb_epoch, [0] * opt.nb_epoch
    ...
    model.load_state_dict(torch.load('models_resnet18/bin_2022_05_09_15_38_54_fold_2_model', map_location='cpu'))
    for i in range(opt.nb_epoch):
        ...
        if er_overall_1sec_list[i] < best_er:
            ...
            model_path = os.path.join(opt.models_resnet18dir, '{}_fold_{}_model'.format(__fig_name, fold))
        ...
        plot_functions(opt.nb_epoch, tr_loss, val_loss, f1_overall_1sec_list, er_overall_1sec_list, '_fold_{}'.format(fold))
