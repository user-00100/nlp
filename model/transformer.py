...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, feat = 64, patch_size=16, in_c=3, embed_dim=768, norm_layer=None):
        super().__init__()
        img_size = (img_size, feat)
...
class VisionTransformer(nn.Module):
    def __init__(self, input_size=224, num_classes=6,
        ...
        self.pos_embed = nn.Parameter(torch.zeros(1, 2, input_size))
    ...
    def forward_features(self, x):
        ...
        # print('cls_token={}'.format(cls_token.shape))
...
def transformer_enconder(size =128, num_classes: int = 6, depth=12, num_heads = 8, has_logits: bool = True):
    """
    ...
    """
    model = VisionTransformer(input_size=size,
                              embed_dim=size,
                              depth=depth,
                              num_heads=num_heads,
