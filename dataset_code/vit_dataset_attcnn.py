...
for fold in [2]:
    ...
    Model().load_state_dict(torch.load('models/bin_2022_04_13_20_48_33_fold_{}_model'.format(fold)))
    ...
    normalized_feat_file = os.path.join(feat_folder, 'attcnn_data_128_fold{}.npz'.format(fold))
